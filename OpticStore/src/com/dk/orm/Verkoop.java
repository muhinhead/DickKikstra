// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Tue Jun 21 10:58:17 CEST 2016
...
//        }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Verkoop(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),new Integer(rs.getInt(11)),new Integer(rs.getInt(12)),rs.getDouble(13),rs.getDouble(14),rs.getDouble(15),rs.getDouble(16),rs.getString(17),rs.getString(18),rs.getString(19),rs.getString(20),rs.getDouble(21),rs.getDouble(22),rs.getString(23),rs.getString(24),rs.getString(25),rs.getDouble(26),rs.getDouble(27),rs.getDouble(28),rs.getDate(29)));
                dbObj.setNew(false);
            }
        } finally {
            try {
