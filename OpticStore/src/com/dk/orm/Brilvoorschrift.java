// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Fri Jun 24 18:05:20 CEST 2016
...
public class Brilvoorschrift extends DbObject  {
    ...
    public Brilvoorschrift(Connection connection) {
        ...
        setColumnNames(new String[]{"brilvoorschrift_id", "klant_id", "od_sph", "od_cyl", "od_as", "od_add", "od_nabil", "od_pr", "od_basis", "od_vis", "od_pddn", "od_lh", "od_ha", "od_iod", "os_sph", "os_cyl", "os_as", "os_add", "os_nabil", "os_pr", "os_basis", "os_pr1", "os_basis1", "os_vis", "os_pddn", "os_lh", "os_ha", "os_iod", "oogmeting_door", "datum_refractie", "anamnese"});
    }

    public Brilvoorschrift(Connection connection, Integer brilvoorschriftId, Integer klantId, Double odSph, Double odCyl, Integer odAs, Double odAdd, Double odNabil, Integer odPr, Integer odBasis, Double odVis, String odPddn, Integer odLh, Integer odHa, Integer odIod, Double osSph, Double osCyl, Integer osAs, Double osAdd, Double osNabil, Integer osPr, Integer osBasis, Integer osPr1, Integer osBasis1, Double osVis, String osPddn, Integer osLh, Integer osHa, Integer osIod, String oogmetingDoor, Date datumRefractie, String anamnese) {
        super(connection, "brilvoorschrift", "brilvoorschrift_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                brilvoorschrift.setOsPr1(new Integer(rs.getInt(22)));
                brilvoorschrift.setOsBasis1(new Integer(rs.getInt(23)));
                brilvoorschrift.setOsVis(rs.getDouble(24));
                brilvoorschrift.setOsPddn(rs.getString(25));
                brilvoorschrift.setOsLh(new Integer(rs.getInt(26)));
                brilvoorschrift.setOsHa(new Integer(rs.getInt(27)));
                brilvoorschrift.setOsIod(new Integer(rs.getInt(28)));
                brilvoorschrift.setOogmetingDoor(rs.getString(29));
                brilvoorschrift.setDatumRefractie(rs.getDate(30));
                brilvoorschrift.setAnamnese(rs.getString(31));
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    ...
                    "SET klant_id = ?, od_sph = ?, od_cyl = ?, od_as = ?, od_add = ?, od_nabil = ?, od_pr = ?, od_basis = ?, od_vis = ?, od_pddn = ?, od_lh = ?, od_ha = ?, od_iod = ?, os_sph = ?, os_cyl = ?, os_as = ?, os_add = ?, os_nabil = ?, os_pr = ?, os_basis = ?, os_pr1 = ?, os_basis1 = ?, os_vis = ?, os_pddn = ?, os_lh = ?, os_ha = ?, os_iod = ?, oogmeting_door = ?, datum_refractie = ?, anamnese = ?" + 
            ...
            try {
                ...
                ps.setObject(21, getOsPr1());
                ps.setObject(22, getOsBasis1());
                ps.setObject(23, getOsVis());
                ps.setObject(24, getOsPddn());
                ps.setObject(25, getOsLh());
                ps.setObject(26, getOsHa());
                ps.setObject(27, getOsIod());
                ps.setObject(28, getOogmetingDoor());
                ps.setObject(29, getDatumRefractie());
                ps.setObject(30, getAnamnese());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT brilvoorschrift_id,klant_id,od_sph,od_cyl,od_as,od_add,od_nabil,od_pr,od_basis,od_vis,od_pddn,od_lh,od_ha,od_iod,os_sph,os_cyl,os_as,os_add,os_nabil,os_pr,os_basis,os_pr1,os_basis1,os_vis,os_pddn,os_lh,os_ha,os_iod,oogmeting_door,datum_refractie,anamnese FROM brilvoorschrift " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[21] = getOsPr1();
        columnValues[22] = getOsBasis1();
        columnValues[23] = getOsVis();
        columnValues[24] = getOsPddn();
        columnValues[25] = getOsLh();
        columnValues[26] = getOsHa();
        columnValues[27] = getOsIod();
        columnValues[28] = getOogmetingDoor();
        columnValues[29] = getDatumRefractie();
        columnValues[30] = getAnamnese();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setOsPr1(Integer.parseInt(flds[21]));
        } catch(NumberFormatException ne) {
            setOsPr1(null);
        }
        try {
            setOsBasis1(Integer.parseInt(flds[22]));
        } catch(NumberFormatException ne) {
            setOsBasis1(null);
        }
        try {
            setOsVis(Double.parseDouble(flds[23]));
        } catch(NumberFormatException ne) {
            setOsVis(null);
        }
        setOsPddn(flds[24]);
        try {
            setOsLh(Integer.parseInt(flds[25]));
        } catch(NumberFormatException ne) {
            setOsLh(null);
        }
        try {
            setOsHa(Integer.parseInt(flds[26]));
        } catch(NumberFormatException ne) {
            setOsHa(null);
        }
        try {
            setOsIod(Integer.parseInt(flds[27]));
        } catch(NumberFormatException ne) {
            setOsIod(null);
        }
        setOogmetingDoor(flds[28]);
        setDatumRefractie(toDate(flds[29]));
        setAnamnese(flds[30]);
    }
}
