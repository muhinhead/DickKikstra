...
insert into dbversion values(1,59,'0.59');
...
create cached table usermessage
(
    usermessage_id int not null generated by default as identity (start with 1),
    sent_at datetime,
    ...
    read_at datetime, 
    message text,
    constraint usermessage_pk primary key (usermessage_id),
    constraint usermessage_userprofile_fk foreign key (sent_by) references userprofile (profile_id) on delete cascade, 
    constraint usermessage_userprofile_fk2 foreign key (recipient) references userprofile (profile_id) on delete cascade
);
...
(
    ...
    constraint xtrip_xmachine_fk1 foreign key (xlowbed_id) references xmachine,
...
(
    ...
    constraint xtripsheet_xmachine_fk foreign key (xlowbed_id) references xmachine,
...
(
    xmachineorder_id    int not null generated by default as identity (start with 1),
    issue_date          date not null,
...
(
    xmachineorderitm_id int not null generated by default as identity (start with 1),
...
(
    xessential_id int not null generated by default as identity (start with 1),
    issue_date date not null,
...
(
    xaccpayment_id int not null generated by default as identity (start with 1),
    xemployee_id   int not null,
...
(
    xmoveableassets_id int not null generated by default as identity (start with 1),
...
(
    xemployeepenalty_id int not null generated by default as identity (start with 1),
...
create table xconfigs
(
    xconfigs_id int not null generated by default as identity (start with 1),
    name varchar(32) not null,
    value varchar(64) not null,
    constraint xconfigs_pk primary key (xconfigs_id)
);

create unique index configs_uniq on xconfigs(name);


create table xunitcosttype
(
    xunitcosttype_id int not null generated by default as identity (start with 1),
    unitcosttype varchar(128) not null,
    period int not null, -- 0-only once, 1-once per year, 2-monthly, 3-weekly, 4-daily
    issued_label varchar(64),
    executed_label varchar(64),
    approved_label varchar(64),
    constraint xunitcosttype_pk primary key (xunitcosttype_id) 
);

create unique index unitcosttype_uniq on xunitcosttype(unitcosttype);

create table xunitcost
(
    xunitcost_id int not null generated by default as identity (start with 1),
    xmachine_id int not null,
    xsite_id int not null,
    xunitcosttype_id int not null,
    issued_by int,
    executed_by int,
    approved_by int,
    amount decimal (10,2) not null,
    ...
    approved_at date,    
    paydate date,
    nextpaydate date, --for subsequent automatic or semiautomatic payments
    comments text,
    constraint xunitcost_pk primary key (xunitcost_id),
    constraint xunitcost_xmachine_fk foreign key (xmachine_id) references xmachine (xmachine_id) on delete cascade,
    constraint xunitcost_xsite_fk foreign key (xsite_id) references xsite (xsite_id), 
    constraint xunitcost_xunitcosttype_fk foreign key (xunitcosttype_id) references xunitcosttype (xunitcosttype_id),
    constraint xunitcost_xemployee_fk foreign key (issued_by) references xemployee (xemployee_id),
    constraint xunitcost_xemployee_fk2 foreign key (executed_by) references xemployee (xemployee_id),
    constraint xunitcost_xemployee_fk3 foreign key (approved_by) references xemployee (xemployee_id)
);

create table xholidays
(
   xholidays_id int not null generated by default as identity (start with 1),
   holiday date not null,
   constraint xholidays_pk primary key (xholidays_id)
);
